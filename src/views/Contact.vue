                       ...
                       <form action="">
                          <div class="row">
                              ...
                              <div class="col-md-7">
                                  ...
                                  <textarea name="" id="" cols="20" rows="6" class="form-control">
                                  </textarea><br><br>
...
.contact__wrapper{
    background: linear-gradient(rgba(4,9,30,.9), rgba(4,9,30,.9)), url('../assets/images/banner2.jpeg');
