        ...
        <div class="dashboard__wrapper">
           ...
           <div class="dashboard__right">
             ...
             <hr>
              ...
              <hr>
              <p class="note">Kindly note that your investment lifecycle will only begin to count when you have been verified to have made payment for your selected plan. Your returns of 30% of your investment and your capital would be paid back in a week. Also, should you find any difficulties in using the platform, kindly use livechat widget to send a message and our customer success team will respond as soon as possible. Happy investing.</p>
              </div>
            <!--End of Dashboard
            =========================-->
              <br>
